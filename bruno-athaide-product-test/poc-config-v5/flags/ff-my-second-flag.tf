...
resource "configcat_setting" "my_second_flag" {
...
# PROD
resource "configcat_setting_value_v2" "my_second_flag_value_prod" {
  environment_id = data.configcat_environments.prod_environment.environments.0.environment_id
  setting_id     = configcat_setting.my_second_flag.id
...
# FORNO
resource "configcat_setting_value_v2" "my_second_flag_value_forno" {
...
# STAGING
resource "configcat_setting_value_v2" "my_second_flag_value_staging" {
