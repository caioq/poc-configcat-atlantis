...
output "prod_environment_name" {
  description = "The production environment name from shared configuration"
  value       = local.prod_environment_name
}

output "forno_environment_name" {
  description = "The forno environment name from shared configuration"
  value       = local.forno_environment_name
}

output "staging_environment_name" {
  description = "The staging environment name from shared configuration"
